        ...
        <>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Form method="get" className="flex flex-wrap items-center gap-2">
              <select name="service" defaultValue={d.service} onChange={(e) => submit(e.currentTarget.form)} className="h-9 w-full max-w-full sm:w-auto rounded-lg border border-border bg-surface px-3 text-[13px] outline-none focus:border-brand/40">
                <option value="all">All instrumented</option>
                {d.services.map((s) => <option key={s} value={s}>{s}</option>)}
              </select>
              <select name="range" defaultValue={d.range} onChange={(e) => submit(e.currentTarget.form)} className="h-9 w-full max-w-full sm:w-auto rounded-lg border border-border bg-surface px-3 text-[13px] outline-none focus:border-brand/40">
            ...
            <select value={method} onChange={(e) => setMethod(e.target.value)} className="h-9 w-full max-w-full sm:w-auto rounded-lg border border-border bg-surface px-3 text-[13px] outline-none focus:border-brand/40">
